...
a1 = stream.audio
v1 = stream.video.crop(x=255, y=0, width=1410, height=1080).filter('scale', '706x540')
stream = ffmpeg.output(v1, a1, output_file, format='tee', vcodec='libx264',  video_bitrate='1500k', acodec='aac', pix_fmt='yuv420p')
